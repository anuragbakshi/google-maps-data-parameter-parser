...
test('Basic route (transit)', () => {
    const g = new Gmdp('https://www.google.co.uk/maps/dir/53.3544359,-2.1083514/Bolton,+UK/@53.458306,-2.4075829,11z/data=!3m1!4b1!4m10!4m9!1m1!4e1!1m5!1m1!1s0x487b0629dc3b1c93:0xcaa40cfafe557822!2m2!1d-2.4282192!2d53.5768647!3e3?hl=en');
    expect(g).toBeInstanceOf(Gmdp);
    expect(g.getMapType()).toBe('map');
...
test('Pin', () => {
    const g = new Gmdp('https://www.google.co.uk/maps/place/V%C3%A4ster%C3%A5s,+Sweden/@59.3033626,15.0198179,10.5z/data=!4m5!3m4!1s0x465e4281455ba9a7:0xbc415db6e2654020!8m2!3d59.6099005!4d16.5448091?hl=en');
    expect(g).toBeInstanceOf(Gmdp);
...
test('Transit, last available with prefs', () => {
    const g = new Gmdp('https://www.google.co.uk/maps/dir/Versailles,+France/Cr%25C3%25A9teil,+France/@48.8053495,2.1524205,11z/data=!3m1!4b1!4m20!4m19!1m5!1m1!1s0x47e67db475f420bd:0x869e00ad0d844aba!2m2!1d2.130122!2d48.801408!1m5!1m1!1s0x47e60caf330272df:0x4573b9315445d467!2m2!1d2.455572!2d48.790367!2m4!4e2!5e0!5e3!6e2!3e3!4e1');
    expect(g).toBeInstanceOf(Gmdp);
